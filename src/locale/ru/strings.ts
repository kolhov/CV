...
export const strings: Locale = {
  ...
  jobs: [
    ...
    },
    {
      ...
      year: '4/2024 – 1/2025',
      months: '(9 месяцев)',
      achievements: ['Кроссплатформенная веб-разработка (MEAN)'],
      stack: [
        'TypeScript',
        'Angular',
        'Tailwind',
    ...
    {
      company: 'Эйдос-Медицина',
      position: 'Frontend-разработчик',
      year: '9/2025 – 2/2026',
      months: '(6 месяцев)',
      achievements: ['Разработка и внедрение frontend-решений для ключевых корпоративных систем в условиях полного цикла производства.',
        'PDM-система: Создание интерфейсов для управления жизненным циклом изделий и инженерными данными.',
        'CRM-система: Разработка клиентской логистики для управления взаимодействием с заказчиками и коммерческими процессами.',
        'Платформа симуляционного центра: Разработка пользовательских интерфейсов для системы управления обучением на роботах-симуляторах пациентов (например, Leonardo). Реализовал сценарии проведения тренировок, мониторинга действий обучающихся и анализа результатов для инструкторов.',
      ],
      stack: [
        'TypeScript',
        'Vue.js',
